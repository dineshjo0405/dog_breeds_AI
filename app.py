...
PREDICTED_LABELS = ["beagle", "bulldog","dalmatian","german-shepherd","husky","labrador-retriever","poodle","rottweiler"]  # edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/1acacfc6-0a8f-4c8e-aa71-6218272e1806'  #Edit 2
...
with tab1:
  #setting up the title
  st.header("Dog breed Classifier")#change according to your project   #edit 3
  #setting up the subheader
  st.subheader("File Uploader")#change according to your project

  #file uploader
  image = st.file_uploader(label="Upload an Dog image to check the breed",accept_multiple_files=False, help="Upload an image to classify them")
  if image:
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/dineshjo0405/dog_breeds_AI")
  ...
  pdf_url = "https://githubusercontent.com/dineshjo0405/dog_breeds_AI/blob/main/VS_Dinesh_AP_POLYTECHNIC_REPORT_WRITING.pdf"
